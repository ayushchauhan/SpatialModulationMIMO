...
figure(1)
plot(Rmin/1000000,W_max,'b-','LineWidth',3);
hold on
plot(Rmin/1000000,Wm_in_Sm,'g--','LineWidth',3);
plot(Rmin/1000000,Wm_in_Em,'r-.','LineWidth',3);
axis([0 30 0.5 0.62])
% % % title('Convergence Plot','FontWeight','bold')
xlabel('Minimum data rate (Mbps)','FontWeight','bold')
